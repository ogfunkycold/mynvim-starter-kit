-- NOTE: Gp.nvim (GPT prompt) Neovim AI plugin
--  ChatGPT like sessions, Instructable text/code operations, Speech to text and Image generation in your
--  favorite editor.-- lazy.nvim
return {
  'robitx/gp.nvim',
  config = function()
    local conf = {
